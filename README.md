...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=25&duration=3000&color=00F7FF&center=true&vCenter=true&width=600&lines=Full+Stack+Developer;AI%2FML+Enthusiast;Cloud+%26+Open+Source+Lover;Building+Impactful+Projects" />
</p>
...
🎯 Passionate about: **Full-Stack, AI/ML, Cloud, Open Source**  
🌍 Based in: **Pune, India**  
⚡ Fun Fact: *Astrophysics + Football conversations = endless* ⚽  

---

## 🚀 What I Bring  
- 🔥 Built **AI-powered systems** with RAG, LLMs & LangChain  
- ⚡ Reduced manual work by **80%** using automation tools  
- 📄 Designed **offline AI chatbot** with **100% privacy**  
- ⚙️ Experience with **scalable backend + real-time apps (<200ms latency)**  
- 🧠 Strong in **DSA + problem solving (300+ problems solved)**  
...
🧠 **AI Stack:** LangChain • LLaMA • FAISS • TensorFlow • PyTorch • OpenCV • RAG  
...
### 🔹 Ask M.I.R.A.G.E  
➡️ AI PDF chatbot (Offline RAG System)  
- ⚡ **Sub-second semantic search** on 100+ page PDFs  
...
### 🔹 NotSoCold  
➡️ Chrome Extension for LinkedIn Automation  
- 🤖 AI-generated personalized outreach  
- ⚡ Reduced manual effort by **~80%**  
- 📈 Bulk apply system for **10+ companies in one click**  

---

### 🔹 Giggity  
➡️ Real-time Chat App  
- ⚡ **<200ms latency messaging system**  
...
- 🥇 **Global Rank 632** — CodeChef Long Challenge  
- 📊 **Top 5K** — Codeforces (Multiple contests)  
- 💯 Solved **300+ DSA problems**  
- 🎓 **AWS Cloud Architect Certified (60 hrs)**  

---

## 📊 Competitive Programming  

- 💻 Codeforces Rating: **1352 (Max)**  
- 🧠 Active on: Codeforces • CodeChef • LeetCode • GFG  
...
[![Portfolio](https://img.shields.io/badge/Portfolio-FF5722?style=for-the-badge&logo=firefox&logoColor=white)](https://aditya-kumar-2358.vercel.app)  
